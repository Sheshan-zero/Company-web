    ...
    <>
     <div className="z-10 mt-20 text-center md:mt-40 md:text-left rounded-3xl bg-clip-text">
        ...
        <div className="flex-col hidden md:flex c-space">
            <motion.h1 className="text-4xl font-medium" variants={variants} initial="hidden" animate="visible" transition={{delay:1}}>We're SIAT</motion.h1>
            <div className="flex flex-col items-start">
                ...
                <motion.p className="text-4xl font-medium text-neutral-400" variants={variants} initial="hidden" animate="visible" transition={{delay:1.8}}>Web Solutions</motion.p>
            </div>
        </div>
        {/*Mobile*/}
        <div className="flex flex-col space-y-6 md:hidden">
          <motion.p className="text-4xl font-medium" variants={variants} initial="hidden" animate="visible" transition={{delay:1}}> We're SIAT</motion.p>
